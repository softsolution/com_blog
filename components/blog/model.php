...
class cms_model_blog{
	...
	public function __construct(){
        ...
        $this->config = cmsCore::getInstance()->loadComponentConfig('blog');
    }
   ...
   public function getCommentTarget($target, $target_id) {
        ...
        switch($target){
            ...
            case 'blog': $sql = "SELECT p.title as title,
                         ...
                         $result['link']  = $this->getPostURL('', $post['seolink']);
...
/* ==================================================================================================== */
    ...
    public static function getPostURL($blogurl='', $seolink){

        return '/blog/'.$seolink.'.html';
...
/* ==================================================================================================== */
    ...
    public static function getBlogURL($page=1, $cat_id=0){

        $cat_section  = ($cat_id >0 ? '/cat-'.$cat_id   : '');
        $page_section = ($page   >1 ? '/page-'.$page    : '');

        return '/blog'.$cat_section.$page_section;
